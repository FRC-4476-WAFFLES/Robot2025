...
public class GroundAlgaePickup extends Command {
  /** Creates a new GroundAlgaePickup. */
  public GroundAlgaePickup() {
  ...
  public void execute() {
    ...
    RobotContainer.superstructure.applySuperstructureState(SuperstructureState.ALGAE_GROUND_PICKUP);
