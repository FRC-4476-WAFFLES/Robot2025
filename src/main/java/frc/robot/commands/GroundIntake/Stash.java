...
public class Stash extends Command {
  ...
  @Override
  public void execute() {
    while(!RobotContainer.groundIntake.isCoralLoaded()){
      RobotContainer.groundIntake.setGroundIntakeSetpoint(GroundIntakeState.STASH);
    } 
   }
  ...
  public boolean isFinished() {
    RobotContainer.groundPivot.setPivotPosition(GroundPivotPosition.STASH);
    return false;
  }
}
