 ...
 */
public class DiscretizationlessSetpointGenerator {
   ...
   *     per second
   */
  public DiscretizationlessSetpointGenerator(RobotConfig config, double maxSteerVelocityRadsPerSec) {
    this.config = config;
   ...
   */
  public DiscretizationlessSetpointGenerator(RobotConfig config, AngularVelocity maxSteerVelocity) {
